...
class App extends Component {
  ...
  render() {
    const {isTrue, score, time, category, imgUrl} = this.state
          ...
          {!isTrue && (
            <div>
              <div className="top-image">
                <img src={imgUrl} alt="match" className="top-image" />
              </div>
                ...
                {tabsList.map(eachTab => (
                  <li className="tab-item" key={eachTab.tabId}>
                    <button
                      ...
                      key={eachTab.tabId}
                      onClick={() => this.onClickTabId(eachTab.tabId)}
                    >
                      {eachTab.displayText}
                    </button>
                    {category === eachTab.tabId ? (
              ...
              <ul className="thumbnail-item-container">
                {thumbnailList.map(eachThumbnail => (
                  <li className="thumbnail-list" key={eachThumbnail.id}>
                    <button
                      type="button"
                      className="thumbnail-button"
                      onClick={() =>
                        this.onClickThumbnail(eachThumbnail.thumbnailUrl)
                      }
                    >
                      <img
          ...
          {isTrue && (
            <div className="score-card-container">
              ...
              >
                ...
                />
                <p className="play-text">PLAY AGAIN</p>
              </button>
            </div>
          )}
        </div>
